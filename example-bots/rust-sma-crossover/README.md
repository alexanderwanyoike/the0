...
A realtime trading bot that implements the Simple Moving Average (SMA) crossover strategy using Rust and live data from Yahoo Finance.
...
### Run locally
```bash
BOT_ID=test BOT_CONFIG='{"symbol":"AAPL"}' cargo run --release
```
