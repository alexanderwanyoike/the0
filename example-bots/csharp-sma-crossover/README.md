...
A realtime trading bot that implements the Simple Moving Average (SMA) crossover strategy using C# .NET 8 and live data from Yahoo Finance.
...
### Run locally
```bash
BOT_ID=test BOT_CONFIG='{"symbol":"AAPL"}' dotnet run
```
