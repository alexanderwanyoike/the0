...
describe('ApiClient', () => {
  ...
  describe('GET requests', () => {
    it('should make authenticated GET request', async () => {
      ...
      expect(response.data).toEqual({ success: true, data: { id: 1, name: 'test' } });
  ...
  describe('POST requests', () => {
    it('should make authenticated POST request with data', async () => {
      ...
      expect(response.data).toEqual({ success: true, data: { id: 1, created: true } });
    });
  ...
  describe('PUT requests', () => {
    it('should make authenticated PUT request', async () => {
      ...
      expect(response.data).toEqual({ success: true, data: { id: 1, updated: true } });
    });
  });
