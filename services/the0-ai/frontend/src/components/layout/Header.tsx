        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="bg-primary h-8 w-8 rounded-md flex items-center justify-center">
              <span className="text-primary-foreground font-mono font-bold text-sm">0</span>
            </div>
          ...
          <div className="text-sm text-muted-foreground">Build trading bots with AI assistance</div>
        </div>
