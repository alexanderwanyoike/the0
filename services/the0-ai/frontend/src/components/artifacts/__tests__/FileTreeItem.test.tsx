...
describe('FileTreeItem', () => {
  it('renders file item correctly', () => {
    ...
    render(
      <FileTreeItem file={mockFile} selectedFile={null} onFileSelect={onFileSelect} level={0} />
    )
  ...
  it('shows selected state when file is selected', () => {
    ...
    render(
      <FileTreeItem file={mockFile} selectedFile={mockFile} onFileSelect={onFileSelect} level={0} />
    )
  ...
  it('renders folder with expand/collapse functionality', () => {
    ...
    render(
      <FileTreeItem file={mockFolder} selectedFile={null} onFileSelect={onFileSelect} level={0} />
    )
