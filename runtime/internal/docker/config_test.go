...
func TestLoadConfigFromEnv_WithOptionalFields(t *testing.T) {
	...
	os.Setenv("MINIO_BACKTESTS_BUCKET", "custom-backtests-bucket")
	...
	defer func() {
		...
		os.Unsetenv("MINIO_BACKTESTS_BUCKET")
	...
	assert.Equal(t, "custom-backtests-bucket", cfg.MinioResultsBucket)
