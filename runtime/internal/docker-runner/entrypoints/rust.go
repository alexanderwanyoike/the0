...
// RustBacktestEntrypoint is an empty placeholder for Rust backtests.
// Rust backtests are pre-built by the CLI, so no code wrapper is needed.
// The bash entrypoint in bash_entrypoint_factory.go handles execution.
const RustBacktestEntrypoint = ""
