...
describe("Custom Bot API Integration Tests", () => {
  ...
  describe("POST /custom-bots/:name (Signed URL Deploy)", () => {
    ...
    it("should return 400 when filePath is missing", async () => {
      ...
      expect(response.body.message).toBe("filePath must be a string");
    });
  ...
  describe("PUT /custom-bots/:name (Signed URL Deploy)", () => {
    it("should update bot with new version successfully", async () => {
      ...
      const mockExistingBot: CustomBot = {
        ...
        version: "1.0.0",
        config: validConfig,
        filePath: "test-user-123/old-file.zip",
        userId: "test-user-123",
        status: "active",
        createdAt: new Date(),
        updatedAt: new Date(),
        ...
        versions: [
          {
            ...
            filePath: "test-user-123/v1.1.zip",
            createdAt: new Date(),
            updatedAt: new Date(),
            status: "active",
          ...
          },
          {
            version: "1.0.0",
            config: validConfig,
            filePath: "test-user-123/v1.0.zip",
            createdAt: new Date(),
            updatedAt: new Date(),
            status: "active",
  ...
  describe("GET /custom-bots/:name/:version", () => {
    it("should get specific version successfully", async () => {
      const mockBot: CustomBot = {
        ...
        version: "1.0.0",
        config: validConfig,
        filePath: "test-user-123/file.zip",
        status: "active",
        userId: "test-user-123",
        createdAt: new Date(),
        updatedAt: new Date(),
  ...
  describe("End-to-end workflow with file uploads", () => {
    it("should complete full bot lifecycle: create -> update -> retrieve", async () => {
      ...
      const mockCreatedBot = {
        ...
        config: createConfig,
        status: "active",
        filePath: "test-user-123/e2e-v1.zip",
        userId: "test-user-123",
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      repository.createNewGlobalVersion.mockResolvedValueOnce(
        Ok({
          ...
          config: updateConfig,
          status: "active",
          filePath: "test-user-123/e2e-v1.1.zip",
          userId: "test-user-123",
          createdAt: new Date(),
          updatedAt: new Date(),
        }),
